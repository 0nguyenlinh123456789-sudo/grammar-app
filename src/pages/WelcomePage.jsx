...
const WelcomePage = ({
  ...
  return (
    <div className="max-w-5xl mx-auto pb-24 font-sans text-slate-800 dark:text-slate-100 selection:bg-yellow-300 transition-colors duration-300">
      ...
      {isResetModalOpen && (
        <div role="dialog" aria-modal="true" aria-labelledby="welcome-reset-title" className="fixed inset-0 z-[140] bg-slate-900/60 dark:bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
