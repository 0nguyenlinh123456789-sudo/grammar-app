...
export function freezesLeft(storage = localStorage) {
...
export function tryConsumeFreezes(missedDays, storage = localStorage) {
...
export function frozeToday(storage = localStorage) {
