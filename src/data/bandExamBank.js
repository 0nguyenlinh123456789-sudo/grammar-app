    ...
    sections: [
      {
        ...
        items: [
          ...
          // ⚠️ Hai câu ở vị trí này lúc đầu là câu hỏi CỦA CHÍNH BÀI NGHE LUYỆN
          // TẬP viết lại bằng lời khác (mã không trùng, nhưng nội dung trùng).
          // Người đã luyện bài đó thì đã biết đáp án — bài thi mất tác dụng.
          // Đã thay bằng hai chỗ khác trong bài mà bộ câu hỏi luyện tập không chạm tới.
          { id: 'eb2-l4', prompt: 'Theo bài, cái gì khởi động một chuỗi domino?', options: ['Một cú đẩy duy nhất vào quân domino đầu hàng', 'Việc xếp các quân domino thành hàng', 'Việc quân domino cuối cùng đổ xuống', 'Việc chọn quân domino to nhất'], answer: 0, explanation: '“You started the domino effect with your single push of a single domino.” — cú đẩy MỘT quân, không phải việc xếp hàng.' },
          { id: 'eb2-l5', prompt: 'Trong ví dụ về hai người bạn cãi nhau, kết cục là gì?', options: ['Họ trở thành kẻ thù của nhau', 'Họ làm hoà sau đó', 'Họ không nói chuyện một thời gian rồi thôi', 'Bài không nói kết cục'], answer: 0, explanation: '“One thing led to another and now they are enemies.”' },
