...
export const grammarDataC1Nghia = [
  {
    ...
    transformation: [
      { original: 'The proposal has some good points, but most of it is weak.', hint: 'Dùng nói giảm với "not entirely without"', answer: 'The proposal is not entirely without merit.', trans: 'Đề xuất đó cũng không đến nỗi vô giá trị.' },
      { original: 'The new rule did not fix the problem; it made it worse.', hint: 'Bắt đầu bằng "Far from"', answer: 'Far from fixing the problem, the new rule made it worse.', trans: 'Chẳng những không sửa được vấn đề, quy định mới còn làm nó tệ hơn.' },
      { original: 'People expected sales to drop. In fact they rose.', hint: 'Dùng "If anything"', answer: 'If anything, sales rose.', trans: 'Nếu có gì thì doanh số còn tăng.' },
      { original: 'She rewrote the essay and then learned it was not required.', hint: 'Dùng "only to"', answer: 'She rewrote the essay, only to learn it was not required.', trans: 'Cô ấy viết lại bài luận, rồi rốt cuộc biết là không cần nộp.' },
      { original: 'He cannot understand the question, and answering it is even further beyond him.', hint: 'Dùng "let alone"', answer: 'He cannot understand the question, let alone answer it.', trans: 'Anh ta hiểu câu hỏi còn không nổi, nói gì đến trả lời.' },
    ],
    matching: [
    ...
    trueFalse: [
      { statement: '"The meal was not bad" là một lời khen hết lời.', answer: false, explanation: 'Đó là khen dè dặt — tạm được, không hơn.' },
      { statement: 'Phần chen giữa hai dấu phẩy thường mang hàm ý người viết không muốn nói to.', answer: true, explanation: 'Bỏ phần chen đi thì câu mất chính cái hàm ý đó.' },
      { statement: '"Far from" có nghĩa là "ở rất xa" trong mọi ngữ cảnh.', answer: false, explanation: 'Đứng đầu mệnh đề, "Far from + V-ing" nghĩa là "chẳng những không".' },
      { statement: 'Mỉa mai cần một chỗ vô lý giữa lời nói và sự việc thì người đọc mới nhận ra.', answer: true, explanation: 'Không có chỗ vô lý đó thì câu chỉ là một câu kể bình thường.' },
      { statement: '"If anything" nghĩa là "nếu có bất cứ thứ gì".', answer: false, explanation: 'Nó báo hiệu thực tế đi NGƯỢC điều vừa nói.' },
    ],
  },
  {
    id: 'c1_raodon',
    ...
    transformation: [
      { original: 'This method is the best one available.', hint: 'Rào đón bằng một trạng từ mức độ', answer: 'This method is arguably the best one available.', trans: 'Có thể nói đây là phương pháp tốt nhất hiện có.' },
      { original: 'Everyone knows that reading improves vocabulary.', hint: 'Dùng khung phi cá nhân', answer: 'It is widely accepted that reading improves vocabulary.', trans: 'Người ta thường cho rằng việc đọc giúp mở rộng vốn từ.' },
      { original: 'We put off the launch until June.', hint: 'Viết lại ở mức trang trọng', answer: 'The launch was postponed until June.', trans: 'Đợt ra mắt đã được hoãn tới tháng Sáu.' },
      { original: 'The course is expensive. It is still worth taking.', hint: 'Dùng khung nhượng bộ Admittedly / Nevertheless', answer: 'Admittedly, the course is expensive. Nevertheless, it is worth taking.', trans: 'Phải thừa nhận khoá học này đắt. Tuy vậy, nó đáng để học.' },
      { original: 'The weather caused the delay.', hint: 'Rào đón bằng động từ khuyết thiếu', answer: 'The delay may have been caused by the weather.', trans: 'Sự chậm trễ có thể là do thời tiết.' },
    ],
    matching: [
    ...
    trueFalse: [
      { statement: 'Ở văn viết học thuật, câu khẳng định tuyệt đối luôn mạnh hơn câu rào đón.', answer: false, explanation: 'Nó bị đọc là thiếu cẩn trọng, chứ không phải mạnh mẽ.' },
      { statement: 'Chồng nhiều lớp rào đón trong một câu làm câu chắc chắn hơn.', answer: false, explanation: 'Chồng lớp thành ra lảng tránh; một lớp là đủ.' },
      { statement: 'Nhượng bộ trước khi phản bác là dấu hiệu của lập luận bậc C1.', answer: true, explanation: 'Bài chỉ nói một phía bị đọc là bài yếu.' },
      { statement: 'Từ càng dài thì càng trang trọng.', answer: false, explanation: '"Utilise" không sang hơn "use", nó chỉ dài hơn.' },
      { statement: 'Không nên rào đón một điều mình đã quyết, ví dụ hạn nộp bài.', answer: true, explanation: 'Rào đón cái mình SUY RA, không rào đón cái mình QUYẾT.' },
    ],
  },
];
