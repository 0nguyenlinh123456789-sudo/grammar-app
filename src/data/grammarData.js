...
import { grammarDataC1Nghia } from './grammarDataC1Nghia';
...
// `grammarDataC1Nghia` là hai bài C1 về NGHĨA KHÔNG NẰM TRONG CHỮ (hàm ý, nói
// giảm, mỉa mai, rào đón). Vòng kiểm 2026-08-26 đo được đề `exam-c1` hỏi đúng
// những thứ đó ở 5/8 câu phần Đọc, trong khi cả kho ngữ pháp C1 không có bài
// nào dạy — xem đầu file grammarDataC1Nghia.js.
export const parsedGrammarData = [...foundationData, ...grammarDataA1, ...grammarDataB1, ...grammarDataB2, ...grammarDataC1C2, ...grammarDataC1Nghia];
...
export const grammarLevels = [
  ...
  { id: 'C1C2', label: '🔴 C1+ - Nâng Cao', description: 'Ngữ pháp chuyên sâu bậc trên B2 — bộ bài gộp chung C1 và C2, chưa tách', color: 'bg-rose-400', topics: [...grammarDataC1C2, ...grammarDataC1Nghia] },
];
