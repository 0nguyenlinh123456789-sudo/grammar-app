...
export const courseData = [
  {
    ...
    "theory": {
      ...
      "practicalUsage": [
        {
          "heading": "💬 Thực hành: A. How are you today? (Hôm nay bạn thế nào?)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "very well / fine",
              "value": "👉 I am very well, thanks. I'm fine, thanks."
            },
            {
              "title": "feel ill / feel sick",
              "value": "👉 I feel ill. Can you get a doctor please. I feel sick and want to vomit."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: B. Everyday problems (Các vấn đề thường gặp)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "headache / toothache",
              "value": "👉 Have you got an aspirin? I've got a headache."
            },
            {
              "title": "a cold / cough",
              "value": "👉 I'm going to bed with a hot drink. I've got a cold."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: C & D. Serious illnesses & Tropical problems (Bệnh nghiêm trọng & Vùng nhiệt đới)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "asthma / hay-fever",
              "value": "👉 My brother has asthma; sometimes he can't breathe."
            },
            {
              "title": "malaria / cholera",
              "value": "👉 Mosquitoes can give people malaria. Dirty water caused cholera."
            },
            {
              "title": "heart attack / cancer",
              "value": "👉 My grandfather had a heart attack. Cancer kills many people."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: E. How to keep fit and well (Cách giữ sức khỏe)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "healthy diet",
              "value": "👉 Eat lots of fruit and vegetables to have a healthy diet."
            },
            {
              "title": "get exercise",
              "value": "👉 Swimming and jogging are good ways to get exercise."
            },
            {
              "title": "stress",
              "value": "👉 Relax after work and don't have too much stress."
            }
          ]
        }
      ],
      "discoveryCorner": [
        {
          ...
          "details": [
            {
              "title": "Họ từ (Word Family) của \"feel ill / feel sick\"",
              "value": "Các dạng từ loại khác của \"feel ill / feel sick\" đang được cập nhật."
            }
          ]
        },
        {
          ...
          "details": [
            {
              "title": "Cụm từ (Collocations) với \"a cold / cough\"",
              "value": "Ví dụ: a cold / cough quickly, always a cold / cough"
            },
            {
              "title": "Cụm từ (Collocations) với \"asthma / hay-fever\"",
              "value": "Ví dụ: have a asthma / hay-fever, make a asthma / hay-fever, good asthma / hay-fever"
            },
            {
              "title": "Cụm từ (Collocations) với \"malaria / cholera\"",
              "value": "Ví dụ: have a malaria / cholera, make a malaria / cholera, good malaria / cholera"
            }
          ]
        }
      ]
    ...
    "textbookExercises": [
      {
        ...
        "questions": [
          {
            "id": "ex_33_2_0",
            "text": "asthma / hay-fever",
            "options": [
              "Cơn đau tim / Bệnh ung thư.",
              "Sốt rét / Bệnh tả (do muỗi đốt hoặc nước bẩn).",
              "Chế độ ăn uống lành mạnh (nhiều rau quả).",
              "Hen suyễn / Dị ứng phấn hoa (hắt hơi liên tục)."
            ],
            "answer": "Hen suyễn / Dị ứng phấn hoa (hắt hơi liên tục).",
            "explanation": "Từ \"asthma / hay-fever\" có nghĩa chính xác là \"Hen suyễn / Dị ứng phấn hoa (hắt hơi liên tục).\"."
          },
          {
            "id": "ex_33_2_1",
            "text": "malaria / cholera",
            "options": [
              "Chế độ ăn uống lành mạnh (nhiều rau quả).",
              "Cơn đau tim / Bệnh ung thư.",
              "Sốt rét / Bệnh tả (do muỗi đốt hoặc nước bẩn).",
            ...
            "answer": "Sốt rét / Bệnh tả (do muỗi đốt hoặc nước bẩn).",
            "explanation": "Từ \"malaria / cholera\" có nghĩa chính xác là \"Sốt rét / Bệnh tả (do muỗi đốt hoặc nước bẩn).\"."
          },
          {
            "id": "ex_33_2_2",
            "text": "heart attack / cancer",
            "options": [
              "Hen suyễn / Dị ứng phấn hoa (hắt hơi liên tục).",
              "Sốt rét / Bệnh tả (do muỗi đốt hoặc nước bẩn).",
              "Cơn đau tim / Bệnh ung thư.",
            ...
            "answer": "Cơn đau tim / Bệnh ung thư.",
            "explanation": "Từ \"heart attack / cancer\" có nghĩa chính xác là \"Cơn đau tim / Bệnh ung thư.\"."
          },
          {
            "id": "ex_33_2_3",
            "text": "healthy diet",
            ...
            "answer": "Chế độ ăn uống lành mạnh (nhiều rau quả).",
            "explanation": "Từ \"healthy diet\" có nghĩa chính xác là \"Chế độ ăn uống lành mạnh (nhiều rau quả).\"."
          }
        ]
      },
      {
        ...
        "questions": [
          {
            ...
            "word": "very well / fine",
            "category": "Topic A",
            "explanation": "Từ \"very well / fine\" thuộc nhóm \"Topic A\"."
          },
          {
            "id": "ex_33_3_1",
            "word": "feel ill / feel sick",
            "category": "Topic B",
            "explanation": "Từ \"feel ill / feel sick\" thuộc nhóm \"Topic B\"."
          },
          {
            "id": "ex_33_3_2",
            "word": "headache / toothache",
            "category": "Topic A",
            "explanation": "Từ \"headache / toothache\" thuộc nhóm \"Topic A\"."
          },
          {
            "id": "ex_33_3_3",
            "word": "a cold / cough",
            "category": "Topic B",
            "explanation": "Từ \"a cold / cough\" thuộc nhóm \"Topic B\"."
          },
          {
            "id": "ex_33_3_4",
            "word": "asthma / hay-fever",
            "category": "Topic A",
            "explanation": "Từ \"asthma / hay-fever\" thuộc nhóm \"Topic A\"."
          },
          {
            "id": "ex_33_3_5",
            "word": "malaria / cholera",
            "category": "Topic B",
            "explanation": "Từ \"malaria / cholera\" thuộc nhóm \"Topic B\"."
          }
        ]
      },
      {
        ...
        "questions": [
          {
            "id": "ex_33_5_3",
            "text": "Eat lots of fruit and vegetables to have a [blank].",
            "answers": [
              "healthy diet"
            ],
            "hint": "Chế độ ăn uống lành mạnh (nhiều rau quả).",
            "explanation": "Từ cần điền là \"healthy diet\"."
          }
        ]
      }
    ]
  },
  {
    ...
    "theory": {
      ...
      "practicalUsage": [
        {
          "heading": "💬 Thực hành: A. Love, like, hate (Tình cảm)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "love / like / don't like / hate",
              "value": "👉 I love my family. I hate my boss. I don't like horror films."
            },
            {
              "title": "prefer",
              "value": "👉 I prefer coffee to tea (Tôi thích cà phê hơn trà)."
            },
            {
              "title": "want / hope",
              "value": "👉 I want to buy a new car. I hope to do well in my exam."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: B. Physical feelings (Cảm giác thể chất)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "happy / sad / angry / surprised",
              "value": "👉 She is happy because she won a prize. He is angry."
            },
            {
              "title": "tired / hungry / thirsty",
              "value": "👉 I am tired and want to sleep. I am hungry, I want a sandwich."
            },
            {
              "title": "cold / hot / well / ill",
              "value": "👉 I am cold, put a sweater on. I feel ill today."
            }
          ]
        }
      ],
      "discoveryCorner": [
        {
          ...
          "details": [
            {
              "title": "Cụm từ (Collocations) với \"happy / sad / angry / surprised\"",
              "value": "Ví dụ: very happy / sad / angry / surprised, extremely happy / sad / angry / surprised"
            },
            {
              "title": "Cụm từ (Collocations) với \"tired / hungry / thirsty\"",
              "value": "Ví dụ: very tired / hungry / thirsty, extremely tired / hungry / thirsty"
            },
            {
              "title": "Cụm từ (Collocations) với \"cold / hot / well / ill\"",
              "value": "Ví dụ: very cold / hot / well / ill, extremely cold / hot / well / ill"
            }
          ]
        }
      ]
        ...
        "questions": [
          {
            ...
            "hint": "Yêu / Thích / Không thích / Ghét.",
            "explanation": "Từ cần điền là \"love / like / don't like / hate\"."
          },
          {
            "id": "ex_34_1_1",
            "text": "The word is [blank].",
            ...
            "hint": "Thích hơn.",
            "explanation": "Từ cần điền là \"prefer\"."
          },
          {
            "id": "ex_34_1_2",
            "text": "The word is [blank].",
            ...
            "hint": "Muốn / Hy vọng (want + to V | hope + to V / hope + clause).",
            "explanation": "Từ cần điền là \"want / hope\"."
          },
          {
            "id": "ex_34_1_3",
            "text": "The word is [blank].",
            ...
            "hint": "Vui vẻ / Buồn bã / Tức giận / Ngạc nhiên.",
            "explanation": "Từ cần điền là \"happy / sad / angry / surprised\"."
          },
          {
            "id": "ex_34_1_4",
            "text": "The word is [blank].",
            ...
            "hint": "Mệt mỏi / Đói bụng / Khát nước.",
            "explanation": "Từ cần điền là \"tired / hungry / thirsty\"."
          },
          {
            "id": "ex_34_1_5",
            "text": "The word is [blank].",
            ...
            "hint": "Lạnh / Nóng / Khỏe / Ốm.",
            "explanation": "Từ cần điền là \"cold / hot / well / ill\"."
          }
        ]
      }
    ]
  },
  {
    ...
    "theory": {
      ...
      "practicalUsage": [
        {
          "heading": "💬 Thực hành: A. Greetings (Chào hỏi thường ngày)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "Good morning / afternoon / evening",
              "value": "👉 Good morning, how are you today?"
            },
            {
              "title": "Hello / Hi",
            ...
            {
              "title": "Goodnight / Sleep well",
              "value": "👉 Goodnight! Sleep well."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: B. Polite phrases (Giao tiếp lịch sự)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "Please / Thank you",
              "value": "👉 Can I have a coffee, please? Thank you very much."
            },
            {
              "title": "Excuse me",
              "value": "👉 Excuse me! Can I get past?"
            },
            {
              "title": "Sorry",
              "value": "👉 I'm sorry I'm late. Oh, sorry!"
            },
            {
              "title": "Bless you!",
              "value": "👉 Atchoo! - Bless you!"
            },
            {
              "title": "Cheers!",
              "value": "👉 Here is your beer. - Cheers!"
            }
          ]
        },
        {
          "heading": "💬 Thực hành: C. Special days (Các dịp đặc biệt)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
            ...
            {
              "title": "Happy New Year / Merry Christmas",
              "value": "👉 Happy New Year! Merry Christmas!"
            },
            {
              "title": "Good luck",
              "value": "👉 Good luck in your driving test!"
            },
            {
              "title": "Congratulations! / Well done!",
              "value": "👉 I passed my exam! - Congratulations!"
            }
          ]
        }
      ],
      "discoveryCorner": [
        {
          ...
          "details": [
            {
              "title": "Họ từ (Word Family) của \"Good morning / afternoon / evening\"",
              "value": "Các dạng từ loại khác của \"Good morning / afternoon / evening\" đang được cập nhật."
            },
            {
              "title": "Họ từ (Word Family) của \"Hello / Hi\"",
              "value": "Các dạng từ loại khác của \"Hello / Hi\" đang được cập nhật."
            },
            {
              "title": "Họ từ (Word Family) của \"Goodbye / See you soon\"",
              "value": "Các dạng từ loại khác của \"Goodbye / See you soon\" đang được cập nhật."
            }
          ]
        }
      ]
        ...
        "questions": [
          {
            ...
            "options": [
              "Vui lòng / Cảm ơn.",
              "Xin lỗi (khi muốn thu hút chú ý hoặc chen qua đám đông).",
              "Xin lỗi (khi mắc lỗi hoặc vô tình va phải ai).",
              "Chúc sức khỏe! (Nói khi có ai đó hắt hơi)."
            ],
            "answer": "Vui lòng / Cảm ơn.",
            "explanation": "Từ \"Please / Thank you\" có nghĩa chính xác là \"Vui lòng / Cảm ơn.\"."
          },
          {
            "id": "ex_35_2_1",
            "text": "Excuse me",
            ...
            "answer": "Xin lỗi (khi muốn thu hút chú ý hoặc chen qua đám đông).",
            "explanation": "Từ \"Excuse me\" có nghĩa chính xác là \"Xin lỗi (khi muốn thu hút chú ý hoặc chen qua đám đông).\"."
          },
          {
            "id": "ex_35_2_2",
            "text": "Sorry",
            ...
            "answer": "Xin lỗi (khi mắc lỗi hoặc vô tình va phải ai).",
            "explanation": "Từ \"Sorry\" có nghĩa chính xác là \"Xin lỗi (khi mắc lỗi hoặc vô tình va phải ai).\"."
          },
          {
            "id": "ex_35_2_3",
            "text": "Bless you!",
            ...
            "answer": "Chúc sức khỏe! (Nói khi có ai đó hắt hơi).",
            "explanation": "Từ \"Bless you!\" có nghĩa chính xác là \"Chúc sức khỏe! (Nói khi có ai đó hắt hơi).\"."
          }
        ]
      },
      {
        ...
        "questions": [
          {
            ...
            "word": "Good morning / afternoon / evening",
            "category": "Topic A",
            "explanation": "Từ \"Good morning / afternoon / evening\" thuộc nhóm \"Topic A\"."
          },
          {
            "id": "ex_35_3_1",
            "word": "Hello / Hi",
            "category": "Topic B",
            "explanation": "Từ \"Hello / Hi\" thuộc nhóm \"Topic B\"."
          },
          {
            "id": "ex_35_3_2",
            "word": "Goodbye / See you soon",
            "category": "Topic A",
            "explanation": "Từ \"Goodbye / See you soon\" thuộc nhóm \"Topic A\"."
          },
          {
            "id": "ex_35_3_3",
            "word": "Goodnight / Sleep well",
            "category": "Topic B",
            "explanation": "Từ \"Goodnight / Sleep well\" thuộc nhóm \"Topic B\"."
          },
          {
            "id": "ex_35_3_4",
            "word": "Please / Thank you",
            "category": "Topic A",
            "explanation": "Từ \"Please / Thank you\" thuộc nhóm \"Topic A\"."
          },
          {
            "id": "ex_35_3_5",
            "word": "Excuse me",
            "category": "Topic B",
            "explanation": "Từ \"Excuse me\" thuộc nhóm \"Topic B\"."
          }
        ]
      },
      {
        ...
        "questions": [
          {
            "id": "ex_35_5_1",
            "text": "[blank]! Can I get past?",
            "answers": [
              "Excuse me"
            ],
            "hint": "Xin lỗi (khi muốn thu hút chú ý hoặc chen qua đám đông).",
            "explanation": "Từ cần điền là \"Excuse me\"."
          },
          {
            "id": "ex_35_5_2",
            "text": "I'm [blank] I'm late. Oh, [blank]!",
            "answers": [
              "Sorry"
            ],
            "hint": "Xin lỗi (khi mắc lỗi hoặc vô tình va phải ai).",
            "explanation": "Từ cần điền là \"Sorry\"."
          }
        ]
      }
    ]
  },
  {
    ...
    "theory": {
      ...
      "practicalUsage": [
        {
          "heading": "💬 Thực hành: A. The Continents (Các châu lục)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "Europe / Asia / Africa",
              "value": "👉 Germany is in Europe. Vietnam is in Asia."
            },
            {
              "title": "North America / South America / Australia",
              "value": "👉 The USA is in North America. Brazil is in South America."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: B. Countries, People and Languages (Quốc gia, Con người và Ngôn ngữ)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "capital letters",
              "value": "👉 Japan [KHÔNG DÙNG: japan], Japanese [KHÔNG DÙNG: japanese]."
            },
            {
              "title": "adjective endings",
              "value": "👉 He is Vietnamese. He speaks Vietnamese."
            },
            {
              "title": "exceptions",
              "value": "👉 Athens is the capital of Greece. The Greeks speak Greek."
            }
          ]
        }
      ],
      "discoveryCorner": [
        {
          ...
          "details": [
            {
              "title": "Họ từ (Word Family) của \"Europe / Asia / Africa\"",
              "value": "Các dạng từ loại khác của \"Europe / Asia / Africa\" đang được cập nhật."
            },
            {
              "title": "Họ từ (Word Family) của \"North America / South America / Australia\"",
              "value": "Các dạng từ loại khác của \"North America / South America / Australia\" đang được cập nhật."
            },
            {
              "title": "Họ từ (Word Family) của \"capital letters\"",
              "value": "Các dạng từ loại khác của \"capital letters\" đang được cập nhật."
            }
          ]
        }
      ]
        ...
        "questions": [
          {
            ...
            "hint": "Châu Âu / Châu Á / Châu Phi.",
            "explanation": "Từ cần điền là \"Europe / Asia / Africa\"."
          },
          {
            "id": "ex_36_1_1",
            "text": "The word is [blank].",
            ...
            "hint": "Bắc Mỹ / Nam Mỹ / Châu Úc (Australia).",
            "explanation": "Từ cần điền là \"North America / South America / Australia\"."
          },
          {
            "id": "ex_36_1_2",
            "text": "The word is [blank].",
            ...
            "hint": "Chữ hoa (Mọi từ chỉ châu lục, đất nước, quốc tịch, ngôn ngữ LUÔN viết hoa chữ cái đầu tiên).",
            "explanation": "Từ cần điền là \"capital letters\"."
          },
          {
            "id": "ex_36_1_3",
            "text": "The word is [blank].",
            ...
            "hint": "Đuôi tính từ chỉ người/ngôn ngữ: -an (German, American, Korean), -ish (British, English, Spanish), -ese (Chinese, Japanese, Vietnamese).",
            "explanation": "Từ cần điền là \"adjective endings\"."
          },
          {
            "id": "ex_36_1_4",
            "text": "The word is [blank].",
            ...
            "hint": "Các trường hợp bất quy tắc: French (từ France), Dutch (từ Holland), Greek (từ Greece), Swiss (từ Switzerland).",
            "explanation": "Từ cần điền là \"exceptions\"."
          }
        ]
      }
    ]
  },
  {
    ...
    "theory": {
      ...
      "practicalUsage": [
        {
          "heading": "💬 Thực hành: A. Types of weather (Các hiện tượng thời tiết)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "sun / rain / wind / cloud",
              "value": "👉 The sun is shining. Rain is falling."
            },
            {
              "title": "snow / fog / thunder / lightning",
              "value": "👉 Look at the lightning in the sky!"
            }
          ]
        },
        {
          "heading": "💬 Thực hành: B. Nouns and Adjectives (Danh từ và Tính từ thời tiết)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "sunny / rainy / windy",
              "value": "👉 It is a sunny day in Tokyo. Today it is very windy."
            },
            {
              "title": "cloudy / snowy / foggy",
              "value": "👉 It's cloudy in London. Drive slowly because it is foggy."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: C. Temperature & Other words (Nhiệt độ)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "hot / warm / cool / cold",
              "value": "👉 It is very hot in Mexico today (35 degrees). It is cold in the Arctic."
            },
            {
              "title": "storm / hurricane / thunderstorm",
              "value": "👉 A hurricane is a very strong wind. We had a thunderstorm last night."
            }
          ]
        }
      ],
      "discoveryCorner": [
        {
          ...
          "details": [
            {
              "title": "Cụm từ (Collocations) với \"cloudy / snowy / foggy\"",
              "value": "Ví dụ: very cloudy / snowy / foggy, extremely cloudy / snowy / foggy"
            },
            {
              "title": "Cụm từ (Collocations) với \"hot / warm / cool / cold\"",
              "value": "Ví dụ: very hot / warm / cool / cold, extremely hot / warm / cool / cold"
            },
            {
              "title": "Cụm từ (Collocations) với \"storm / hurricane / thunderstorm\"",
              "value": "Ví dụ: have a storm / hurricane / thunderstorm, make a storm / hurricane / thunderstorm, good storm / hurricane / thunderstorm"
            }
          ]
        }
      ]
        ...
        "questions": [
          {
            ...
            "hint": "Mặt trời / Cơn mưa / Gió / Đám mây.",
            "explanation": "Từ cần điền là \"sun / rain / wind / cloud\"."
          },
          {
            "id": "ex_37_1_1",
            "text": "The word is [blank].",
            "answers": [
              "snow / fog / thunder / lightning"
            ],
            "hint": "Tuyết / Sương mù / Sấm / Sét.",
            "explanation": "Từ cần điền là \"snow / fog / thunder / lightning\"."
          },
          {
            "id": "ex_37_1_2",
            "text": "The word is [blank].",
            ...
            "hint": "Có nắng / Có mưa / Có gió (Thêm '-y' vào sau danh từ).",
            "explanation": "Từ cần điền là \"sunny / rainy / windy\"."
          },
          {
            "id": "ex_37_1_3",
            "text": "The word is [blank].",
            ...
            "hint": "Nhiều mây / Có tuyết / Nhiều sương mù (Gấp đôi phụ âm cuối trước khi thêm '-y' đối với fog -> foggy, sun -> sunny).",
            "explanation": "Từ cần điền là \"cloudy / snowy / foggy\"."
          },
          {
            "id": "ex_37_1_4",
            "text": "The word is [blank].",
            ...
            "hint": "Nóng / Ấm áp / Mát mẻ / Lạnh.",
            "explanation": "Từ cần điền là \"hot / warm / cool / cold\"."
          },
          {
            "id": "ex_37_1_5",
            "text": "The word is [blank].",
            ...
            "hint": "Bão / Cuồng phong / Bão kèm sấm chớp.",
            "explanation": "Từ cần điền là \"storm / hurricane / thunderstorm\"."
          }
        ]
      }
    ]
  },
  {
    ...
    "theory": {
      ...
      "practicalUsage": [
        {
          "heading": "💬 Thực hành: A. The town centre (Trung tâm thị trấn/thành phố)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "railway station / bus station",
              "value": "👉 You can get a train at the railway station."
            },
            {
              "title": "bank / post office / library",
              "value": "👉 You can change money at the bank. Post letters at the post office."
            },
            {
              "title": "museum / town hall / car park",
              "value": "👉 You can see old things in the museum. Park in the car park."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: B. Streets and roads & Signs (Đường sá & Biển báo)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "pedestrian area / shopping centre",
              "value": "👉 A pedestrian area is for walking only, no cars."
            },
            {
              "title": "no parking / no entry / bus stop",
              "value": "👉 Look at the 'No Parking' sign."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: C. Asking for help (Cách hỏi đường)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "Where is the...?",
              "value": "👉 Where is the main square please?"
            },
            {
              "title": "How do I get to...?",
              "value": "👉 How do I get to York Street?"
            },
            {
              "title": "Excuse me, I'm looking for...",
              "value": "👉 Excuse me, I'm looking for the museum."
            }
          ]
        }
      ],
      "discoveryCorner": [
        {
          ...
          "details": [
            {
              "title": "Họ từ (Word Family) của \"railway station / bus station\"",
              "value": "Các dạng từ loại khác của \"railway station / bus station\" đang được cập nhật."
            },
            {
              "title": "Họ từ (Word Family) của \"bank / post office / library\"",
              "value": "Các dạng từ loại khác của \"bank / post office / library\" đang được cập nhật."
            },
            {
              "title": "Họ từ (Word Family) của \"museum / town hall / car park\"",
              "value": "Các dạng từ loại khác của \"museum / town hall / car park\" đang được cập nhật."
            }
          ]
        }
      ]
    ...
    "textbookExercises": [
      {
        ...
        "questions": [
          {
            "id": "ex_38_2_0",
            "text": "no parking / no entry / bus stop",
            "options": [
              "Cấm đỗ xe / Cấm vào / Điểm dừng xe buýt.",
              "Đường đến... ở đâu?",
              "Làm thế nào để tôi đi đến...?",
              "Xin lỗi, tôi đang tìm kiếm..."
            ],
            "answer": "Cấm đỗ xe / Cấm vào / Điểm dừng xe buýt.",
            "explanation": "Từ \"no parking / no entry / bus stop\" có nghĩa chính xác là \"Cấm đỗ xe / Cấm vào / Điểm dừng xe buýt.\"."
          },
          {
            "id": "ex_38_2_1",
            "text": "Where is the...?",
            ...
            "answer": "Đường đến... ở đâu?",
            "explanation": "Từ \"Where is the...?\" có nghĩa chính xác là \"Đường đến... ở đâu?\"."
          },
          {
            "id": "ex_38_2_2",
            ...
            "answer": "Làm thế nào để tôi đi đến...?",
            "explanation": "Từ \"How do I get to...?\" có nghĩa chính xác là \"Làm thế nào để tôi đi đến...?\"."
          },
          {
            "id": "ex_38_2_3",
            "text": "Excuse me, I'm looking for...",
            "options": [
              "Cấm đỗ xe / Cấm vào / Điểm dừng xe buýt.",
              "Đường đến... ở đâu?",
              "Xin lỗi, tôi đang tìm kiếm...",
            ...
            "answer": "Xin lỗi, tôi đang tìm kiếm...",
            "explanation": "Từ \"Excuse me, I'm looking for...\" có nghĩa chính xác là \"Xin lỗi, tôi đang tìm kiếm...\"."
          }
        ]
      },
      {
        ...
        "questions": [
          {
            ...
            "word": "railway station / bus station",
            "category": "Topic A",
            "explanation": "Từ \"railway station / bus station\" thuộc nhóm \"Topic A\"."
          },
          {
            "id": "ex_38_3_1",
            "word": "bank / post office / library",
            "category": "Topic B",
            "explanation": "Từ \"bank / post office / library\" thuộc nhóm \"Topic B\"."
          },
          {
            "id": "ex_38_3_2",
            "word": "museum / town hall / car park",
            "category": "Topic A",
            "explanation": "Từ \"museum / town hall / car park\" thuộc nhóm \"Topic A\"."
          },
          {
            "id": "ex_38_3_3",
            "word": "pedestrian area / shopping centre",
            "category": "Topic B",
            "explanation": "Từ \"pedestrian area / shopping centre\" thuộc nhóm \"Topic B\"."
          },
          {
            "id": "ex_38_3_4",
            "word": "no parking / no entry / bus stop",
            "category": "Topic A",
            "explanation": "Từ \"no parking / no entry / bus stop\" thuộc nhóm \"Topic A\"."
          },
          {
            "id": "ex_38_3_5",
            "word": "Where is the...?",
            "category": "Topic B",
            "explanation": "Từ \"Where is the...?\" thuộc nhóm \"Topic B\"."
          }
        ]
      }
    ]
  },
  {
    ...
    "theory": {
      ...
      "practicalUsage": [
        {
          "heading": "💬 Thực hành: A. Things we can see in the countryside (Cảnh quan nông thôn)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "mountains / hills / forest / wood",
              "value": "👉 You can go walking in the mountains. A forest has thousands of trees."
            },
            {
              "title": "lake / river / country road / path",
              "value": "👉 We took a boat on the lake. Follow the path through the wood."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: B. Living and working in the countryside (Sống và làm việc ở nông thôn)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "village / small town",
              "value": "👉 A village is very small (e.g. 700 people)."
            },
            {
              "title": "farm / farmer / fields",
              "value": "👉 A farmer lives on a farm and works in the fields."
            },
            {
              "title": "cottage",
              "value": "👉 My grandparents live in a beautiful cottage."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: C. Nature and conservation (Thiên nhiên & bảo tồn)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "nature / wildlife",
              "value": "👉 I love walking in the countryside and seeing wildlife. Nature means the natural world."
            },
            {
              "title": "national park / conservation area",
              "value": "👉 In a national park, nature and wildlife are protected."
            }
          ]
        }
      ],
      "discoveryCorner": [
        {
          ...
          "details": [
            {
              "title": "Cụm từ (Collocations) với \"farm / farmer / fields\"",
              "value": "Ví dụ: have a farm / farmer / fields, make a farm / farmer / fields, good farm / farmer / fields"
            },
            {
              "title": "Cụm từ (Collocations) với \"cottage\"",
              "value": "Ví dụ: have a cottage, make a cottage, good cottage"
            },
            {
              "title": "Cụm từ (Collocations) với \"nature / wildlife\"",
              "value": "Ví dụ: have a nature / wildlife, make a nature / wildlife, good nature / wildlife"
            }
          ]
        }
      ]
        ...
        "questions": [
          {
            ...
            "text": "The word is [blank].",
            "answers": [
              "mountains / hills / forest / wood"
            ],
            "hint": "Dãy núi / Đồi / Rừng rậm / Rừng thưa.",
            "explanation": "Từ cần điền là \"mountains / hills / forest / wood\"."
          },
          {
            "id": "ex_39_1_1",
            "text": "The word is [blank].",
            "answers": [
              "lake / river / country road / path"
            ],
            "hint": "Hồ nước / Dòng sông / Đường quê / Lối mòn.",
            "explanation": "Từ cần điền là \"lake / river / country road / path\"."
          },
          {
            "id": "ex_39_1_2",
            "text": "The word is [blank].",
            ...
            "hint": "Ngôi làng / Thị trấn nhỏ.",
            "explanation": "Từ cần điền là \"village / small town\"."
          },
          {
            "id": "ex_39_1_3",
            "text": "The word is [blank].",
            ...
            "hint": "Trang trại / Nông dân / Cánh đồng.",
            "explanation": "Từ cần điền là \"farm / farmer / fields\"."
          },
          {
            "id": "ex_39_1_4",
            "text": "The word is [blank].",
            ...
            "hint": "Nhà tranh, nhà nhỏ ở quê.",
            "explanation": "Từ cần điền là \"cottage\"."
          },
          {
            "id": "ex_39_1_5",
            "text": "The word is [blank].",
            ...
            "hint": "Tự nhiên / Động vật hoang dã (chim, thú, côn trùng).",
            "explanation": "Từ cần điền là \"nature / wildlife\"."
          },
          {
            "id": "ex_39_1_6",
            "text": "The word is [blank].",
            ...
            "hint": "Công viên quốc gia / Khu bảo tồn.",
            "explanation": "Từ cần điền là \"national park / conservation area\"."
          }
        ]
      }
    ]
  },
  {
    ...
    "theory": {
      ...
      "practicalUsage": [
        {
          "heading": "💬 Thực hành: A. Farm animals (Động vật trang trại)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "horse / cow / sheep / pig / hen",
              "value": "👉 Sheep give us wool. Cows give us milk and beef."
            },
            {
              "title": "meat names",
              "value": "👉 I like eating lamb."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: B. Wild or zoo animals (Động vật hoang dã)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "elephant / giraffe / lion / tiger",
              "value": "👉 A giraffe has a very long neck. Sư tử is the king of the jungle."
            },
            {
              "title": "monkey / snake",
              "value": "👉 Monkeys love eating bananas. Watch out for the snake!"
            }
          ]
        },
        {
          "heading": "💬 Thực hành: C. Pets (Thú cưng)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "dog / cat / fish / parrot / tortoise",
              "value": "👉 I take my dog for a walk every day. Parrots and budgies are birds."
            }
          ]
        }
      ],
      "discoveryCorner": [
        {
          ...
          "details": [
            {
              "title": "Họ từ (Word Family) của \"meat names\"",
              "value": "Các dạng từ loại khác của \"meat names\" đang được cập nhật."
            }
          ]
        },
        {
          ...
          "details": [
            {
              "title": "Cụm từ (Collocations) với \"monkey / snake\"",
              "value": "Ví dụ: have a monkey / snake, make a monkey / snake, good monkey / snake"
            },
            {
              "title": "Cụm từ (Collocations) với \"dog / cat / fish / parrot / tortoise\"",
              "value": "Ví dụ: have a dog / cat / fish / parrot / tortoise, make a dog / cat / fish / parrot / tortoise, good dog / cat / fish / parrot / tortoise"
            }
          ]
        }
      ]
        ...
        "questions": [
          {
            ...
            "text": "The word is [blank].",
            "answers": [
              "horse / cow / sheep / pig / hen"
            ],
            "hint": "Con ngựa / Bò / Cừu / Heo / Gà mái.",
            "explanation": "Từ cần điền là \"horse / cow / sheep / pig / hen\"."
          },
          {
            "id": "ex_40_1_1",
            "text": "The word is [blank].",
            ...
            "hint": "Tên thịt tương ứng: cow -> beef, sheep -> lamb, pig -> pork/bacon/ham, hen -> chicken.",
            "explanation": "Từ cần điền là \"meat names\"."
          },
          {
            "id": "ex_40_1_2",
            "text": "The word is [blank].",
            ...
            "hint": "Con voi / Hươu cao cổ / Sư tử / Hổ.",
            "explanation": "Từ cần điền là \"elephant / giraffe / lion / tiger\"."
          },
          {
            "id": "ex_40_1_3",
            "text": "The word is [blank].",
            ...
            "hint": "Con khỉ / Con rắn.",
            "explanation": "Từ cần điền là \"monkey / snake\"."
          },
          {
            "id": "ex_40_1_4",
            "text": "The word is [blank].",
            "answers": [
              "dog / cat / fish / parrot / tortoise"
            ],
            "hint": "Con chó / Mèo / Cá / Con vẹt / Con rùa.",
            "explanation": "Từ cần điền là \"dog / cat / fish / parrot / tortoise\"."
          }
        ]
      }
    ]
  },
  {
    ...
    "theory": {
      ...
      "practicalUsage": [
        {
          "heading": "💬 Thực hành: A. Types of transport (Các loại phương tiện)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "train / plane / car / bus",
              "value": "👉 Travelling by plane is very fast. I go to school by bus."
            },
            {
              "title": "motorbike / underground / boat",
              "value": "👉 In London we take the underground."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: B. Travel vocabulary (Thuật ngữ du lịch)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "timetable / map",
              "value": "👉 Check the timetable to see when the train departs."
            },
            {
              "title": "single ticket / return ticket",
              "value": "👉 Can I have a return ticket to Oxford please?"
            },
            {
              "title": "book a seat",
              "value": "👉 I want to book a seat in advance."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: C & D. By train and plane (Đi tàu và máy bay)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "arrive at platform",
              "value": "👉 The train departs from platform 6."
            },
            {
              "title": "check in / takes off / land",
              "value": "👉 Check in 2 hours before the plane takes off. The plane landed safely."
            }
          ]
        }
      ],
      "discoveryCorner": [
        {
          ...
          "details": [
            {
              "title": "Họ từ (Word Family) của \"train / plane / car / bus\"",
              "value": "Các dạng từ loại khác của \"train / plane / car / bus\" đang được cập nhật."
            },
            {
              "title": "Họ từ (Word Family) của \"motorbike / underground / boat\"",
              "value": "Các dạng từ loại khác của \"motorbike / underground / boat\" đang được cập nhật."
            },
            {
              "title": "Họ từ (Word Family) của \"timetable / map\"",
              "value": "Các dạng từ loại khác của \"timetable / map\" đang được cập nhật."
            }
          ]
        },
        {
          ...
          "details": [
            {
              "title": "Cụm từ (Collocations) với \"book a seat\"",
              "value": "Ví dụ: book a seat quickly, always book a seat"
            }
          ]
        }
      ]
        ...
        "questions": [
          {
            ...
            "hint": "Tàu hỏa / Máy bay / Ô tô / Xe buýt.",
            "explanation": "Từ cần điền là \"train / plane / car / bus\"."
          },
          {
            "id": "ex_41_1_1",
            "text": "The word is [blank].",
            "answers": [
              "motorbike / underground / boat"
            ],
            "hint": "Xe máy / Tàu điện ngầm / Thuyền.",
            "explanation": "Từ cần điền là \"motorbike / underground / boat\"."
          },
          {
            "id": "ex_41_1_2",
            "text": "The word is [blank].",
            ...
            "hint": "Lịch trình tàu chạy / Bản đồ.",
            "explanation": "Từ cần điền là \"timetable / map\"."
          },
          {
            "id": "ex_41_1_3",
            "text": "The word is [blank].",
            ...
            "hint": "Vé một chiều / Vé khứ hồi.",
            "explanation": "Từ cần điền là \"single ticket / return ticket\"."
          },
          {
            "id": "ex_41_1_4",
            "text": "The word is [blank].",
            ...
            "hint": "Đặt chỗ trước.",
            "explanation": "Từ cần điền là \"book a seat\"."
          },
          {
            "id": "ex_41_1_5",
            "text": "The word is [blank].",
            ...
            "hint": "Đến sân ga số...",
            "explanation": "Từ cần điền là \"arrive at platform\"."
          },
          {
            "id": "ex_41_1_6",
            "text": "The word is [blank].",
            "answers": [
              "check in / takes off / land"
            ],
            "hint": "Thủ tục lên máy bay / Cất cánh / Hạ cánh.",
            "explanation": "Từ cần điền là \"check in / takes off / land\"."
          }
        ]
      }
    ]
  },
  {
    ...
    "theory": {
      ...
      "practicalUsage": [
        {
          "heading": "💬 Thực hành: A. Common Notices (Các thông báo phổ biến)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "No smoking",
              "value": "👉 You can see 'No Smoking' in restaurants and planes."
            },
            {
              "title": "Out of order",
              "value": "👉 The public telephone is out of order."
            },
            {
              "title": "No camping / No parking",
              "value": "👉 There is a 'No Parking' sign outside the gate."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: B. Doors and Shops (Cửa và cửa hàng)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "Push / Pull",
              "value": "👉 Push the door to enter, pull it to exit."
            },
            {
              "title": "Open / Closed",
              "value": "👉 The shop is closed on Sunday."
            },
            {
              "title": "Sale",
              "value": "👉 The big summer sale starts today."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: C & D. Instructions & Information (Chỉ dẫn & Thông tin)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "Please pay here",
              "value": "👉 Take your items to the cash desk: 'Please pay here'."
            },
            {
              "title": "Please do not walk on the grass",
              "value": "👉 You see this notice in public parks."
            },
            {
              "title": "Queue this side",
              "value": "👉 Please queue this side to buy tickets."
            }
          ]
        }
      ],
      "discoveryCorner": [
        {
          ...
          "details": [
            {
              "title": "Họ từ (Word Family) của \"No smoking\"",
              "value": "Các dạng từ loại khác của \"No smoking\" đang được cập nhật."
            },
            {
            ...
            {
              "title": "Họ từ (Word Family) của \"No camping / No parking\"",
              "value": "Các dạng từ loại khác của \"No camping / No parking\" đang được cập nhật."
            }
          ]
        }
      ]
    ...
    "textbookExercises": [
      {
        ...
        "questions": [
          {
            "id": "ex_42_1_0",
            "text": "You can see '[blank]' in restaurants and planes.",
            "answers": [
              "No smoking"
            ],
            "hint": "Cấm hút thuốc.",
            "explanation": "Từ cần điền là \"No smoking\", mang nghĩa là \"Cấm hút thuốc.\"."
          },
          {
            "id": "ex_42_1_1",
            "text": "The public telephone is [blank].",
            "answers": [
              "Out of order"
            ],
            "hint": "Máy hỏng, không hoạt động (dùng cho điện thoại công cộng, máy bán nước).",
            "explanation": "Từ cần điền là \"Out of order\", mang nghĩa là \"Máy hỏng, không hoạt động (dùng cho điện thoại công cộng, máy bán nước).\"."
          }
        ]
      },
      {
        ...
        "questions": [
          {
            ...
            "text": "Open / Closed",
            "options": [
              "Đợt giảm giá, xả hàng.",
              "Mở cửa / Đóng cửa.",
              "Vui lòng không đi bộ trên cỏ.",
              "Vui lòng thanh toán tại đây (ở quầy thu ngân)."
            ],
            "answer": "Mở cửa / Đóng cửa.",
            "explanation": "Từ \"Open / Closed\" có nghĩa chính xác là \"Mở cửa / Đóng cửa.\"."
          },
          {
            "id": "ex_42_2_1",
            "text": "Sale",
            ...
            "answer": "Đợt giảm giá, xả hàng.",
            "explanation": "Từ \"Sale\" có nghĩa chính xác là \"Đợt giảm giá, xả hàng.\"."
          },
          {
            "id": "ex_42_2_2",
            "text": "Please pay here",
            "options": [
              "Vui lòng không đi bộ trên cỏ.",
              "Mở cửa / Đóng cửa.",
              "Vui lòng thanh toán tại đây (ở quầy thu ngân).",
            ...
            "answer": "Vui lòng thanh toán tại đây (ở quầy thu ngân).",
            "explanation": "Từ \"Please pay here\" có nghĩa chính xác là \"Vui lòng thanh toán tại đây (ở quầy thu ngân).\"."
          },
          {
            "id": "ex_42_2_3",
            "text": "Please do not walk on the grass",
            "options": [
              "Đợt giảm giá, xả hàng.",
              "Mở cửa / Đóng cửa.",
              "Vui lòng thanh toán tại đây (ở quầy thu ngân).",
            ...
            "answer": "Vui lòng không đi bộ trên cỏ.",
            "explanation": "Từ \"Please do not walk on the grass\" có nghĩa chính xác là \"Vui lòng không đi bộ trên cỏ.\"."
          }
        ]
      },
      {
        ...
        "questions": [
          {
            ...
            "word": "No smoking",
            "category": "Topic A",
            "explanation": "Từ \"No smoking\" thuộc nhóm \"Topic A\"."
          },
          {
            "id": "ex_42_3_1",
            "word": "Out of order",
            "category": "Topic B",
            "explanation": "Từ \"Out of order\" thuộc nhóm \"Topic B\"."
          },
          {
            "id": "ex_42_3_2",
            "word": "No camping / No parking",
            "category": "Topic A",
            "explanation": "Từ \"No camping / No parking\" thuộc nhóm \"Topic A\"."
          },
          {
            "id": "ex_42_3_3",
            "word": "Push / Pull",
            "category": "Topic B",
            "explanation": "Từ \"Push / Pull\" thuộc nhóm \"Topic B\"."
          },
          {
            "id": "ex_42_3_4",
            "word": "Open / Closed",
            "category": "Topic A",
            "explanation": "Từ \"Open / Closed\" thuộc nhóm \"Topic A\"."
          },
          {
            "id": "ex_42_3_5",
            "word": "Sale",
            "category": "Topic B",
            "explanation": "Từ \"Sale\" thuộc nhóm \"Topic B\"."
          }
        ]
      },
      {
        ...
        "questions": [
          {
            "id": "ex_42_5_1",
            "text": "The big summer [blank] starts today.",
            "answers": [
              "Sale"
            ],
            "hint": "Đợt giảm giá, xả hàng.",
            "explanation": "Từ cần điền là \"Sale\"."
          },
          {
            "id": "ex_42_5_2",
            "text": "Take your items to the cash desk: '[blank]'.",
            "answers": [
              "Please pay here"
            ],
            "hint": "Vui lòng thanh toán tại đây (ở quầy thu ngân).",
            "explanation": "Từ cần điền là \"Please pay here\"."
          }
        ]
      }
    ]
  },
  {
    ...
    "theory": {
      ...
      "practicalUsage": [
        {
          "heading": "💬 Thực hành: A. Everyday food (Thức ăn hằng ngày)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "bread / rice / pasta",
              "value": "👉 In China, most people eat rice. In Italy, pasta is very popular."
            },
            {
              "title": "meat / fish",
              "value": "👉 Some people do not eat meat or fish."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: B. Popular food & Fast food (Đồ ăn nhanh)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "hot-dog / hamburger / pizza",
              "value": "👉 Young people love fast food like pizza and hot-dogs."
            },
            {
              "title": "fish and chips",
              "value": "👉 Most British people like fish and chips."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: C. Fruit and vegetables (Hoa quả & Rau củ)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "carrot / bean / potato / tomato",
              "value": "👉 Vegetables are good for you."
            },
            {
              "title": "apple / banana / pear / grape / strawberry",
              "value": "👉 Fruit is also good for you (Fruit ở dạng số ít không đếm được nói chung)."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: D. Drinks (Đồ uống)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "tea / coffee / milk / fruit juice",
              "value": "👉 I drink a glass of milk in the morning."
            },
            {
              "title": "beer / wine / mineral water",
              "value": "👉 Would you like a glass of red wine?"
            }
          ]
        }
      ],
      "discoveryCorner": [
        {
          ...
          "details": [
            {
              "title": "Cụm từ (Collocations) với \"fish and chips\"",
              "value": "Ví dụ: have a fish and chips, make a fish and chips, good fish and chips"
            }
          ]
        }
      ]
    ...
    "textbookExercises": [
      {
        ...
        "questions": [
          {
            "id": "ex_43_1_3",
            "text": "Most British people like [blank].",
            "answers": [
              "fish and chips"
            ],
            "hint": "Cá chiên kèm khoai tây chiên (Món ăn truyền thống của người Anh).",
            "explanation": "Từ cần điền là \"fish and chips\", mang nghĩa là \"Cá chiên kèm khoai tây chiên (Món ăn truyền thống của người Anh).\"."
          }
        ]
      },
      {
        ...
        "questions": [
          {
            "id": "ex_43_2_0",
            "text": "carrot / bean / potato / tomato",
            "options": [
              "Bia / Rượu vang / Nước khoáng.",
              "Trà / Cà phê / Sữa / Nước ép hoa quả.",
              "Quả táo / Chuối / Lê / Nho / Dâu tây.",
              "Cà rốt / Hạt đậu / Khoai tây / Cà chua."
            ],
            "answer": "Cà rốt / Hạt đậu / Khoai tây / Cà chua.",
            "explanation": "Từ \"carrot / bean / potato / tomato\" có nghĩa chính xác là \"Cà rốt / Hạt đậu / Khoai tây / Cà chua.\"."
          },
          {
            "id": "ex_43_2_1",
            "text": "apple / banana / pear / grape / strawberry",
            "options": [
              "Bia / Rượu vang / Nước khoáng.",
              "Trà / Cà phê / Sữa / Nước ép hoa quả.",
              "Quả táo / Chuối / Lê / Nho / Dâu tây.",
            ...
            "answer": "Quả táo / Chuối / Lê / Nho / Dâu tây.",
            "explanation": "Từ \"apple / banana / pear / grape / strawberry\" có nghĩa chính xác là \"Quả táo / Chuối / Lê / Nho / Dâu tây.\"."
          },
          {
            "id": "ex_43_2_2",
            "text": "tea / coffee / milk / fruit juice",
            "options": [
              "Bia / Rượu vang / Nước khoáng.",
              "Trà / Cà phê / Sữa / Nước ép hoa quả.",
              "Quả táo / Chuối / Lê / Nho / Dâu tây.",
            ...
            "answer": "Trà / Cà phê / Sữa / Nước ép hoa quả.",
            "explanation": "Từ \"tea / coffee / milk / fruit juice\" có nghĩa chính xác là \"Trà / Cà phê / Sữa / Nước ép hoa quả.\"."
          },
          {
            "id": "ex_43_2_3",
            "text": "beer / wine / mineral water",
            "options": [
              "Cà rốt / Hạt đậu / Khoai tây / Cà chua.",
              "Trà / Cà phê / Sữa / Nước ép hoa quả.",
              "Bia / Rượu vang / Nước khoáng.",
            ...
            "answer": "Bia / Rượu vang / Nước khoáng.",
            "explanation": "Từ \"beer / wine / mineral water\" có nghĩa chính xác là \"Bia / Rượu vang / Nước khoáng.\"."
          }
        ]
      },
      {
        ...
        "questions": [
          {
            ...
            "word": "bread / rice / pasta",
            "category": "Topic A",
            "explanation": "Từ \"bread / rice / pasta\" thuộc nhóm \"Topic A\"."
          },
          {
            "id": "ex_43_3_1",
            "word": "meat / fish",
            "category": "Topic B",
            "explanation": "Từ \"meat / fish\" thuộc nhóm \"Topic B\"."
          },
          {
            "id": "ex_43_3_2",
            "word": "hot-dog / hamburger / pizza",
            "category": "Topic A",
            "explanation": "Từ \"hot-dog / hamburger / pizza\" thuộc nhóm \"Topic A\"."
          },
          {
            "id": "ex_43_3_3",
            "word": "fish and chips",
            "category": "Topic B",
            "explanation": "Từ \"fish and chips\" thuộc nhóm \"Topic B\"."
          },
          {
            "id": "ex_43_3_4",
            "word": "carrot / bean / potato / tomato",
            "category": "Topic A",
            "explanation": "Từ \"carrot / bean / potato / tomato\" thuộc nhóm \"Topic A\"."
          },
          {
            "id": "ex_43_3_5",
            "word": "apple / banana / pear / grape / strawberry",
            "category": "Topic B",
            "explanation": "Từ \"apple / banana / pear / grape / strawberry\" thuộc nhóm \"Topic B\"."
          }
        ]
      },
      {
        ...
        "questions": [
          {
            "id": "ex_43_4_1",
            "original": "Most British people like fish and chip.",
            "correct": "Most British people like fish and chips.",
            "explanation": "Từ viết đúng chính tả/ngữ pháp phải là \"fish and chips\" thay vì \"fish and chip\"."
          }
        ]
      }
    ]
  },
  {
    ...
    "theory": {
      ...
      "practicalUsage": [
        {
          "heading": "💬 Thực hành: A. What's in the kitchen? (Có gì trong bếp?)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "fridge / freezer",
              "value": "👉 Keep the milk in the fridge. The ice is in the freezer."
            },
            {
              "title": "cooker / microwave",
              "value": "👉 Cook dinner on the cooker. Heat the soup in the microwave."
            },
            {
              "title": "sink / cupboard / taps",
              "value": "👉 Put the dirty dishes in the sink. Turn the tap on."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: B. Tools we use in the kitchen (Dụng cụ nấu ăn)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "saucepan / frying pan",
              "value": "👉 Boil potatoes in a saucepan. Fry eggs in a frying pan."
            },
            {
              "title": "washing-up liquid / teapot",
              "value": "👉 Wash the dishes with washing-up liquid. Put tea in the teapot."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: C. Tools for eating and drinking (Dụng cụ ăn uống)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "cup / plate / bowl / saucer",
              "value": "👉 Pour tea into the cup. Eat soup from a bowl."
            },
            {
              "title": "knife / fork / spoon / chopsticks",
              "value": "👉 Cut meat with a knife. Eat rice with chopsticks."
            }
          ]
        }
      ],
      "discoveryCorner": [
        {
          ...
          "details": [
            {
              "title": "Họ từ (Word Family) của \"fridge / freezer\"",
              "value": "Các dạng từ loại khác của \"fridge / freezer\" đang được cập nhật."
            },
            {
              "title": "Họ từ (Word Family) của \"cooker / microwave\"",
              "value": "Các dạng từ loại khác của \"cooker / microwave\" đang được cập nhật."
            },
            {
              "title": "Họ từ (Word Family) của \"sink / cupboard / taps\"",
              "value": "Các dạng từ loại khác của \"sink / cupboard / taps\" đang được cập nhật."
            }
          ]
        }
      ]
        ...
        "questions": [
          {
            ...
            "hint": "Tủ lạnh / Tủ đông.",
            "explanation": "Từ cần điền là \"fridge / freezer\"."
          },
          {
            "id": "ex_44_1_1",
            "text": "The word is [blank].",
            ...
            "hint": "Bếp nấu / Lò vi sóng.",
            "explanation": "Từ cần điền là \"cooker / microwave\"."
          },
          {
            "id": "ex_44_1_2",
            "text": "The word is [blank].",
            ...
            "hint": "Bồn rửa chén / Tủ ly chén / Vòi nước.",
            "explanation": "Từ cần điền là \"sink / cupboard / taps\"."
          },
          {
            "id": "ex_44_1_3",
            "text": "The word is [blank].",
            ...
            "hint": "Nồi sâu lòng / Chảo rán.",
            "explanation": "Từ cần điền là \"saucepan / frying pan\"."
          },
          {
            "id": "ex_44_1_4",
            "text": "The word is [blank].",
            "answers": [
              "washing-up liquid / teapot"
            ],
            "hint": "Nước rửa chén / Ấm pha trà.",
            "explanation": "Từ cần điền là \"washing-up liquid / teapot\"."
          },
          {
            "id": "ex_44_1_5",
            "text": "The word is [blank].",
            "answers": [
              "cup / plate / bowl / saucer"
            ],
            "hint": "Cái tách / Đĩa / Bát / Đĩa lót tách.",
            "explanation": "Từ cần điền là \"cup / plate / bowl / saucer\"."
          },
          {
            "id": "ex_44_1_6",
            "text": "The word is [blank].",
            ...
            "hint": "Con dao / Cái nĩa / Cái thìa / Đôi đũa.",
            "explanation": "Từ cần điền là \"knife / fork / spoon / chopsticks\"."
          }
        ]
      }
    ]
  },
  {
    ...
    "theory": {
      ...
      "practicalUsage": [
        {
          "heading": "💬 Thực hành: A. The bedroom (Phòng ngủ)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "bed / alarm clock / wardrobe",
              "value": "👉 I wake up when the alarm clock rings. Hang your coat in the wardrobe."
            },
            {
              "title": "dressing table / chest of drawers / bedside table",
              "value": "👉 Put the alarm clock on the bedside table."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: B. The bathroom (Phòng tắm)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "shower / bath / basin / toilet",
              "value": "👉 I have a shower in the morning. Put water in the basin."
            },
            {
              "title": "soap / shampoo / toothpaste / toothbrush / towel",
              "value": "👉 Wash your hands with soap. Clean teeth with toothbrush and toothpaste."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: C. Joel's routine (Thói quen hằng ngày của Joel)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "wake up / get up / get dressed",
              "value": "👉 Joel wakes up at 7, gets up at 7.15, and gets dressed."
            },
            {
              "title": "clean teeth / turn off the light / fall asleep",
              "value": "👉 He cleans his teeth, turns off the light, and falls asleep."
            }
          ]
        }
      ],
      "discoveryCorner": [
        {
          ...
          "details": [
            {
              "title": "Họ từ (Word Family) của \"bed / alarm clock / wardrobe\"",
              "value": "Các dạng từ loại khác của \"bed / alarm clock / wardrobe\" đang được cập nhật."
            },
            {
              "title": "Họ từ (Word Family) của \"dressing table / chest of drawers / bedside table\"",
              "value": "Các dạng từ loại khác của \"dressing table / chest of drawers / bedside table\" đang được cập nhật."
            },
            {
              "title": "Họ từ (Word Family) của \"shower / bath / basin / toilet\"",
              "value": "Các dạng từ loại khác của \"shower / bath / basin / toilet\" đang được cập nhật."
            }
          ]
        }
      ]
        ...
        "questions": [
          {
            ...
            "text": "The word is [blank].",
            "answers": [
              "bed / alarm clock / wardrobe"
            ],
            "hint": "Giường ngủ / Đồng hồ báo thức / Tủ quần áo.",
            "explanation": "Từ cần điền là \"bed / alarm clock / wardrobe\"."
          },
          {
            "id": "ex_45_1_1",
            "text": "The word is [blank].",
            "answers": [
              "dressing table / chest of drawers / bedside table"
            ],
            "hint": "Bàn trang điểm / Tủ nhiều ngăn kéo / Bàn đầu giường.",
            "explanation": "Từ cần điền là \"dressing table / chest of drawers / bedside table\"."
          },
          {
            "id": "ex_45_1_2",
            "text": "The word is [blank].",
            ...
            "hint": "Vòi sen / Bồn tắm / Bồn rửa mặt / Bồn cầu.",
            "explanation": "Từ cần điền là \"shower / bath / basin / toilet\"."
          },
          {
            "id": "ex_45_1_3",
            "text": "The word is [blank].",
            "answers": [
              "soap / shampoo / toothpaste / toothbrush / towel"
            ],
            "hint": "Xà bông / Dầu gội / Kem đánh răng / Bàn chải / Khăn tắm.",
            "explanation": "Từ cần điền là \"soap / shampoo / toothpaste / toothbrush / towel\"."
          },
          {
            "id": "ex_45_1_4",
            "text": "The word is [blank].",
            ...
            "hint": "Thức giấc / Thức dậy (ra khỏi giường) / Mặc quần áo.",
            "explanation": "Từ cần điền là \"wake up / get up / get dressed\"."
          },
          {
            "id": "ex_45_1_5",
            "text": "The word is [blank].",
            "answers": [
              "clean teeth / turn off the light / fall asleep"
            ],
            "hint": "Đánh răng / Tắt đèn / Ngủ thiếp đi.",
            "explanation": "Từ cần điền là \"clean teeth / turn off the light / fall asleep\"."
          }
        ]
      }
    ]
  },
  {
    ...
    "theory": {
      ...
      "practicalUsage": [
        {
          "heading": "💬 Thực hành: A. Things in the living room (Đồ đạc phòng khách)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "sofa / armchair",
              "value": "👉 Two people can sit on the sofa. I sat in the armchair."
            },
            {
              "title": "bookshelf / power point / light switch",
              "value": "👉 Put the novels on the bookshelf. Plug the TV into the power point."
            },
            {
              "title": "coffee table / carpet / curtains",
              "value": "👉 We put cups on the coffee table. Close the curtains because it is dark."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: B. Useful prepositions (Giới từ chỉ vị trí)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "near / next to / in the corner",
              "value": "👉 The sofa is near the window. The TV is in the corner."
            },
            {
              "title": "against the wall / under",
              "value": "👉 The bookshelf is against the wall. The book is under the table."
            }
          ]
        },
        {
          "heading": "💬 Thực hành: C & D. Things we do and use (Hành động & Thiết bị)",
          "intro": "Các mẫu câu thông dụng:",
          "details": [
            {
              "title": "watch television / listen to the radio",
              "value": "👉 Every evening I watch television. I listen to the radio in the morning."
            },
            {
              "title": "remote control / reading lamp",
              "value": "👉 Where is the remote control for the TV? Turn on the reading lamp."
            }
          ]
        }
      ],
      "discoveryCorner": [
        {
          ...
          "details": [
            {
              "title": "Họ từ (Word Family) của \"sofa / armchair\"",
              "value": "Các dạng từ loại khác của \"sofa / armchair\" đang được cập nhật."
            },
            {
              "title": "Họ từ (Word Family) của \"bookshelf / power point / light switch\"",
              "value": "Các dạng từ loại khác của \"bookshelf / power point / light switch\" đang được cập nhật."
            },
            {
              "title": "Họ từ (Word Family) của \"coffee table / carpet / curtains\"",
              "value": "Các dạng từ loại khác của \"coffee table / carpet / curtains\" đang được cập nhật."
            }
          ]
        }
      ]
        ...
        "questions": [
          {
            ...
            "hint": "Ghế sofa / Ghế bành (có tay vịn).",
            "explanation": "Từ cần điền là \"sofa / armchair\"."
          },
          {
            "id": "ex_46_1_1",
            "text": "The word is [blank].",
            "answers": [
              "bookshelf / power point / light switch"
            ],
            "hint": "Kệ sách / Ổ cắm điện / Công tắc đèn.",
            "explanation": "Từ cần điền là \"bookshelf / power point / light switch\"."
          },
          {
            "id": "ex_46_1_2",
            "text": "The word is [blank].",
            "answers": [
              "coffee table / carpet / curtains"
            ],
            "hint": "Bàn trà nhỏ / Tấm thảm trải sàn / Rèm cửa sổ.",
            "explanation": "Từ cần điền là \"coffee table / carpet / curtains\"."
          },
          {
            "id": "ex_46_1_3",
            "text": "The word is [blank].",
            "answers": [
              "near / next to / in the corner"
            ],
            "hint": "Gần / Ngay bên cạnh / Trong góc phòng.",
            "explanation": "Từ cần điền là \"near / next to / in the corner\"."
          },
          {
            "id": "ex_46_1_4",
            "text": "The word is [blank].",
            "answers": [
              "against the wall / under"
            ],
            "hint": "Tựa vào tường / Bên dưới.",
            "explanation": "Từ cần điền là \"against the wall / under\"."
          },
          {
            "id": "ex_46_1_5",
            "text": "The word is [blank].",
            ...
            "hint": "Xem tivi / Nghe đài.",
            "explanation": "Từ cần điền là \"watch television / listen to the radio\"."
          },
          {
            "id": "ex_46_1_6",
            "text": "The word is [blank].",
            "answers": [
              "remote control / reading lamp"
            ],
            "hint": "Điều khiển từ xa / Đèn đọc sách.",
            "explanation": "Từ cần điền là \"remote control / reading lamp\"."
          }
        ]
      }
    ]
