...
import { kenhDatMua, loiNhanDatMua, saoChepLoiNhan, CHUA_CO_KENH, CHUA_CO_GIA, giaGoi } from '../../utils/banHang';
...
function PricingModal({ onClose }) {
  ...
  const loiNhan = daChon ? loiNhanDatMua(daChon, import.meta.env) : '';
