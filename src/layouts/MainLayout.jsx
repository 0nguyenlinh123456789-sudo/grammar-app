...
const MainLayout = ({
  ...
  return (
    <div className="min-h-screen bg-[#f4f0ec] dark:bg-slate-950 flex flex-col lg:flex-row font-sans text-slate-800 dark:text-slate-100 selection:bg-yellow-300 transition-colors duration-300">
      ...
      {isResetModalOpen && (
        <div role="dialog" aria-modal="true" aria-labelledby="reset-roadmap-title" className="fixed inset-0 z-[140] bg-slate-900/60 dark:bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
