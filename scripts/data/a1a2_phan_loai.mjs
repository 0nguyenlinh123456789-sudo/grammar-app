...
export const PHAN_LOAI_A2 = {
  ...
  'weather-seasons-daily-p2': { nhom: 'soan', xong: true, vi: 'ĐÃ VIẾT LẠI 19/08: thành một năm của hai thửa ruộng — xuân mưa muộn ba tuần rồi mưa chín ngày liền, bão tháng Mười tới bốn ngày trước khi cắt xong nên mất trắng thửa thứ ba, và bố đổi cách làm: cắt sớm một tuần dù lúa chưa đẹp.' },
  'hobbies-interests-daily': { nhom: 'soan', xong: true, vi: 'ĐÃ VIẾT LẠI 19/08: thành chuyện bộ sưu tập tiền xu cậu để lại — bán hết trừ hai phong bì đựng xu mua đúng năm người kể sinh ra, và luật riêng là chỉ lấy xu của nước mà người trong nhà đã đặt chân tới.' },
  'transport-travel-daily': { nhom: 'soan', xong: true, vi: 'ĐÃ VIẾT LẠI 19/08: thành đêm mười một tiếng ở sân bay — mẹo là hỏi hãng chi trả gì chứ không hỏi mấy giờ bay, phiếu ăn vô dụng vì cửa hàng đóng lúc mười một giờ, vali tới muộn hai ngày với một chai nước mắm bung ra.' },
  'health-body-daily-p2': { nhom: 'soan', xong: true, vi: 'ĐÃ VIẾT LẠI 19/08: thành tám tuần tập chạy năm ki-lô-mét — vai đau vì giữ tay quá cao, bác sĩ giải thích đầu gối đau vì bắp cơ phía trên yếu, nghỉ mười hai ngày, và về đích ba mươi bốn phút dưới mưa.' },
  'technology-gadgets-daily': { nhom: 'soan', xong: true, vi: 'ĐÃ VIẾT LẠI 19/08: thành chuyện điện thoại chết hai ngày trước kỳ thi — cửa hàng thứ hai thay bộ phận lấy từ máy cùng đời, chạy được chín phút đủ để sao ảnh, và cái sai thật là chỉ giữ MỘT bản của thứ quan trọng.' },
  'entertainment-media-daily-p2': { nhom: 'soan', xong: true, vi: 'ĐÃ VIẾT LẠI 19/08: thành tờ báo trường bốn trang mười một người đọc — không ai muốn viết nhưng ai cũng muốn được phỏng vấn, cô nấu bếp nhận ra lớp nào đi hành lang chỉ bằng tiếng, và báo địa phương in lại mà viết sai tên cô.' },
  'culture-traditions-daily': { nhom: 'soan', xong: true, vi: 'ĐÃ VIẾT LẠI 19/08: thành Tết ở làng bà với việc chia theo từng người — mẹ và cô nấu, bố và cậu dọn sửa, trẻ con bê đồ; tiền trong bao đỏ phải là tờ mới nên bà trả lại tiền cũ của anh họ mà không nói một tiếng.' },
  'weather-climate-daily': { nhom: 'soan', xong: true, vi: 'ĐÃ VIẾT LẠI 19/08: thành trận lụt lên tới bậc thứ hai — bố nghe dòng sông chứ không nghe radio vì sông lên thì đổi tiếng trước khi đổi mực nước, và lớp bùn ở lại còn tệ hơn cả nước.' },
  'nature-environment-daily': { nhom: 'soan', xong: true, vi: 'ĐÃ VIẾT LẠI 19/08: thành buổi dọn rác con suối sau khu nhà — xin mười người thì ba mươi mốt người tới, ông Tuấn ghi danh sách vì "danh sách khó cãi hơn một lời phàn nàn", và mục đích thật là để láng giềng nói chuyện với nhau.' },
